...
<body>
    ...
    <script>
        ...
        let ringsEnabled = false;  // Disabled by default - requires THREE.js
        let logoLabelsEnabled = false;  // Disabled - requires separate THREE.js which conflicts
